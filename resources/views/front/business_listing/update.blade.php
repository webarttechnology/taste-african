...
<div class="goodup-dashboard-wrap gray px-4 py-5">
    ...
    <div class="goodup-dashboard-content">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control rounded" placeholder=""
                                                    name="latitude" value="{{ old('latitude', $listing->latitude) }}" />
                                                <div class="validation-error">
                                                    @error('latitude')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                        ...
                                        <div id="menu-container">
                                            @foreach ($listing->menuitems as $listing_menuitems)
                                                <div>
                                                    ...
                                                    <input type="hidden" name="menu_item_image_old[]" value="{{ $listing_menuitems->image }}">
                                                    <button type="button"
        ...
        <div class="row menu-row d-none mb-2" style="border:2px solid black">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="form-group">
                    <button type="button" class="btn btn-danger" onclick="removespecificMenuRow(this, event)">Remove</button>
                </div>
            </div>
        </div>
        {{-- Div for Menu --}}
