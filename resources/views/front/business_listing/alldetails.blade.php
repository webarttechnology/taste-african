...
@section('content')
		...
		<div class="featured-slick">
			<div class="featured-gallery-slide">
				<div class="dlf-flew"><a href="assets/img/lg-1.png" class="mfp-gallery"><img src="assets/img/lg-1.png"
							class="img-fluid mx-auto" alt="" /></a></div>
				<div class="dlf-flew"><a href="assets/img/lg-2.png" class="mfp-gallery"><img src="assets/img/lg-2.png"
							class="img-fluid mx-auto" alt="" /></a></div>
				<div class="dlf-flew"><a href="assets/img/lg-3.png" class="mfp-gallery"><img src="assets/img/lg-3.png"
							class="img-fluid mx-auto" alt="" /></a></div>
				<div class="dlf-flew"><a href="assets/img/lg-4.png" class="mfp-gallery"><img src="assets/img/lg-4.png"
							class="img-fluid mx-auto" alt="" /></a></div>
				<div class="dlf-flew"><a href="assets/img/lg-5.png" class="mfp-gallery"><img src="assets/img/lg-5.png"
							class="img-fluid mx-auto" alt="" /></a></div>
				<div class="dlf-flew"><a href="assets/img/lg-6.png" class="mfp-gallery"><img src="assets/img/lg-6.png"
							class="img-fluid mx-auto" alt="" /></a></div>
				<div class="dlf-flew"><a href="assets/img/lg-7.png" class="mfp-gallery"><img src="assets/img/lg-7.png"
							class="img-fluid mx-auto" alt="" /></a></div>
				<div class="dlf-flew"><a href="assets/img/lg-8.png" class="mfp-gallery"><img src="assets/img/lg-8.png"
							class="img-fluid mx-auto" alt="" /></a></div>
			</div>
			<div class="ftl-diope"><a href="javascript:void(0);" class="btn bg-white text-dark ft-medium rounded">See
					20+ Photos</a></div>
				...
				<div class="Goodup-lkp-flex d-flex align-items-start justify-content-start">
					...
					<div class="Goodup-lkp-caption ps-3">
						<div class="Goodup-lkp-title">
							<h1 class="text-light mb-0 ft-bold">Sake Cafe Sushi Bar & Grill</h4>
						</div>
							...
							<div class="list-lioe">
								...
								<div class="list-lioe-single ms-2 ps-3 seperate">
									<a href="javascript:void(0);" class="text-light ft-medium">Chicken Wings</a>,<a
										href="javascript:void(0);" class="text-light ft-medium ms-1">Sports Bars</a>,<a
										href="javascript:void(0);" class="text-light ft-medium ms-1">American
										(Traditional)</a>,<a href="javascript:void(0);"
										class="text-light ft-medium ms-1">Seafood</a>
								</div>
							</div>
						</div>
						<div class="d-block mt-1">
							<div class="list-lioe">
								<div class="list-lioe-single"><span class="ft-medium text-danger">Closed</span><span
							...
							<div class="jbd-01 px-4 py-4">
								<div class="jbd-details">
									...
									<div class="d-block mt-3">
										...
										<p class="p-0 m-0">Temporibus autem quibusdam et aut officiis debitis aut rerum
											necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae
											non recusandae. Itaque earum rerum hic tenetur</p>
									</div>
								</div>
												...
												<div class="Goodup-sng-menu">
													...
													<div class="Goodup-sng-menu-caption">
														...
														<div class="lkji-oiyt"><span>Start From</span>
															<h5 class="theme-cl ft-bold">$49</h5>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
												<div class="Goodup-sng-menu">
													...
													<div class="Goodup-sng-menu-caption">
														...
														<div class="lkji-oiyt"><span>Start From</span>
															<h5 class="theme-cl ft-bold">$129</h5>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
												<div class="Goodup-sng-menu">
													...
													<div class="Goodup-sng-menu-caption">
														...
														<div class="lkji-oiyt"><span>Start From</span>
															<h5 class="theme-cl ft-bold">$79</h5>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
												<div class="Goodup-sng-menu">
													...
													<div class="Goodup-sng-menu-caption">
														...
														<div class="lkji-oiyt"><span>Start From</span>
															<h5 class="theme-cl ft-bold">$60</h5>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
												<div class="Goodup-sng-menu">
													...
													<div class="Goodup-sng-menu-caption">
														...
														<div class="lkji-oiyt"><span>Start From</span>
															<h5 class="theme-cl ft-bold">$120</h5>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
												<div class="Goodup-sng-menu">
													...
													<div class="Goodup-sng-menu-caption">
														...
														<div class="lkji-oiyt"><span>Start From</span>
															<h5 class="theme-cl ft-bold">$99</h5>
														</div>
													</div>
												</div>
											</div>
							...
							<div class="jbd-01 px-4 py-4">
								<div class="jbd-details mb-4">
									...
									<div class="Goodup-all-features-list mt-3">
										<ul>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg" class=""
														alt="" /><span>Health Score 8.7 / 10</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Offers Delivery</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Offers Takeout</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Reservations</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Staff wears masks</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Vegan Options</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Vegetarian Options</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Accepts Credit Cards</span>
												</div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Casual</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Moderate Noise</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Offers Catering</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Good for Groups</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Good For Kids</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Good for Breakfast</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Brunch, Lunch, Dinner</span>
												</div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Private Lot Parking</span>
												</div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Waiter Service</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Free Wi-Fi</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Beer & Wine</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Drive-Thru</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace deactive"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Wheelchair Accessible</span>
												</div>
											</li>
											<li>
												<div class="Goodup-afl-pace deactive"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>TV Services</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace deactive"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Outdoor Seating</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace deactive"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Happy Hour</span></div>
											</li>
											<li>
												<div class="Goodup-afl-pace deactive"><img src="assets/img/verify.svg"
														class="img-fluid" alt="" /><span>Pets Allow</span></div>
											</li>
										</ul>
									</div>
								</div>
									...
									<div class="reviews-comments-wrap">
										...
										<div class="reviews-comments-item">
											...
											<div class="reviews-comments-item-text">
												<h4><a href="#">Kayla E. Claxton</a><span
										...
										<div class="reviews-comments-item">
											...
											<div class="reviews-comments-item-text">
												<h4><a href="#">Amy M. Taylor</a><span
														class="reviews-comments-item-date"><i
															class="ti-calendar theme-cl me-1"></i>2 Nov May 2019</span>
												</h4>
												<span class="agd-location"><i
														class="lni lni-map-marker me-1"></i>Liverpool, London UK</span>
										...
										<div class="reviews-comments-item">
											...
											<div class="reviews-comments-item-text">
												<h4><a href="#">Susan C. Daggett</a><span
														class="reviews-comments-item-date"><i
															class="ti-calendar theme-cl me-1"></i>10 Nov 2019</span>
												</h4>
												<span class="agd-location"><i
														class="lni lni-map-marker me-1"></i>Denver, United State</span>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
						...
						<div class="jb-apply-form bg-white rounded py-4 px-4 box-static mb-4">
							...
							<form class="_apply_form_form">
								...
								<div class="form-group">
									<button type="button"
										class="btn btn-md rounded theme-bg text-light ft-medium fs-sm full-width">Start
										Your Order</button>
								</div>
							</form>
						...
						<div class="row g-3 mb-3">
							<div class="col-4"><a href="javascript:void(0);" class="adv-btn full-width"><i
										class="fas fa-camera"></i>Add Phoos</a></div>
							<div class="col-4"><a href="javascript:void(0);" class="adv-btn full-width"><i
										class="fas fa-share"></i>Share</a></div>
							<div class="col-4"><a href="javascript:void(0);" class="adv-btn full-width"><i
										class="fas fa-heart"></i>Save</a></div>
						</div>
						...
						<div class="Goodup-grid-wrap">
							<div class="Goodup-grid-upper">
								...
								<div class="Goodup-grid-thumb">
									<a href="#" class="d-block text-center m-auto"><img src="assets/img/listing/l-5.jpg"
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
						<div class="Goodup-grid-wrap">
							<div class="Goodup-grid-upper">
								...
								<div class="Goodup-grid-thumb">
									<a href="#" class="d-block text-center m-auto"><img src="assets/img/listing/l-6.jpg"
											class="img-fluid" alt=""></a>
								</div>
								<div class="Goodup-rating overlay">
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
						<div class="Goodup-grid-wrap">
							<div class="Goodup-grid-upper">
								...
								<div class="Goodup-grid-thumb">
									<a href="#" class="d-block text-center m-auto"><img src="assets/img/listing/l-7.jpg"
											class="img-fluid" alt=""></a>
								</div>
								<div class="Goodup-rating overlay">
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
						<div class="Goodup-grid-wrap">
							<div class="Goodup-grid-upper">
								...
								<div class="Goodup-grid-thumb">
									<a href="#" class="d-block text-center m-auto"><img src="assets/img/listing/l-8.jpg"
											class="img-fluid" alt=""></a>
								</div>
								<div class="Goodup-rating overlay">
