<?php include("header.php") ?>p
		<!-- ============================================================== -->
		<!-- Start Navigation -->
		<div class="header header-light dark-text head-shadow d-none">
			<div class="container">
				<nav id="navigation" class="navigation navigation-landscape">
					<div class="nav-header">
						<a class="nav-brand" href="index.html">
							<img src="assets/img/logos/logo.png" class="logo" alt="" />
						</a>
					...
					<div class="nav-menus-wrapper" style="transition-property: none;">
						<ul class="nav-menu">
							...
							<li><a href="listing-detail.html">Listing Details</a>
								<!-- <ul class="nav-dropdown nav-submenu">
										<li><a href="#"><i class="lni lni-dashboard me-2"></i>Dashboard</a></li>
										<li><a href="#"><i class="lni lni-files me-2"></i>My Listings</a></li>
		...
		<section class="bg-cover position-relative" style="background:red url(assets/img/cover.jpg) no-repeat;"
			data-overlay="3">
			<div class="abs-list-sec"><a href="#" class="add-list-btn"><i class="fas fa-plus me-2"></i>Add Listing</a>
			</div>
			<div class="container">
				<div class="row">
				...
				<div class="goodup-dashboard-nav sticky-top">
					<div class="goodup-dashboard-inner">
						<ul data-submenu-title="Main Navigation">
							<li><a href="#"><i class="lni lni-dashboard me-2"></i>Dashboard</a></li>
							<li class="active"><a href="#"><i class="lni lni-files me-2"></i>My Listings</a></li>
							<li><a href="#"><i class="lni lni-add-files me-2"></i>Add
									Listing</a></li>
							<li><a href="#"><i class="lni lni-bookmark me-2"></i>Saved
									Listing</a></li>
							<li><a href="#"><i class="lni lni-briefcase me-2"></i>My
									Bookings<span class="count-tag bg-warning">4</span></a></li>
							<li><a href="#"><i class="lni lni-mastercard me-2"></i>Wallet</a></li>
							<li><a href="#"><i class="lni lni-envelope me-2"></i>Messages<span
										class="count-tag">4</span></a></li>
						</ul>
						<ul data-submenu-title="My Accounts">
							<li><a href="#"><i class="lni lni-user me-2"></i>My Profile </a>
							</li>
							<li><a href="#"><i class="lni lni-lock-alt me-2"></i>Change
									Password</a></li>
							<li><a href="javascript:void(0);"><i class="lni lni-trash-can me-2"></i>Delete Account</a>
							</li>
							<li><a href="#"><i class="lni lni-power-switch me-2"></i>Log Out</a></li>
						</ul>
					</div>
				</div>
			</div>
								...
								<div class="dashboard-list-wraps-head br-bottom py-3 px-3">
									<div class="dashboard-list-wraps-flx">
										<h4 class="mb-0 ft-medium fs-md"><i
												class="fa fa-file-alt me-2 theme-cl fs-sm"></i>My Listings</h4>
									</div>
								</div>
