...
@section('content')
		<!-- ======================= Home Banner ======================== -->
		<div class="home-banner margin-bottom-0" style="background:#0c6018 url(assets/img/banner-6.jpg) no-repeat;"
			data-overlay="5">
			<div class="container">
					...
					<div class="col-xl-11 col-lg-12 col-md-12 col-12">
						...
						<div class="Goodup-search-shadow">
							...
							<ul class="nav nav-tabs search-tab mb-3" id="myTab" role="tablist">
								<li class="nav-item" role="presentation">
									<button class="nav-link active" id="placesseach-tab" data-bs-toggle="tab"
										data-bs-target="#placesseach" type="button" role="tab"
										aria-controls="placesseach" aria-selected="true">Places</button>
								</li>
								<li class="nav-item" role="presentation">
									<button class="nav-link" id="carseach-tab" data-bs-toggle="tab"
										data-bs-target="#carseach" type="button" role="tab" aria-controls="carseach"
										aria-selected="false">Car</button>
								</li>
								<li class="nav-item" role="presentation">
									<button class="nav-link" id="realseach-tab" data-bs-toggle="tab"
										data-bs-target="#realseach" type="button" role="tab" aria-controls="realseach"
							...
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="placesseach" role="tabpanel"
									...
									<form class="main-search-wrap fl-wrap">
										...
										<div class="main-search-button">
											<button class="btn full-width theme-bg text-white"
								...
								<div class="tab-pane fade" id="realseach" role="tabpanel"
									aria-labelledby="realseach-tab">
									<form class="main-search-wrap fl-wrap">
										<div class="main-search-item">
											<span class="search-tag"><i class="lni lni-keyboard"></i></span>
											<input type="text" class="form-control radius"
								...
								<div class="tab-pane fade" id="eventseach" role="tabpanel"
									aria-labelledby="eventseach-tab">
									<form class="main-search-wrap fl-wrap">
										<div class="main-search-item">
											<span class="search-tag"><i class="lni lni-keyboard"></i></span>
											<input type="text" class="form-control radius"
											...
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/foods/food-01.jpg" class="img-fluid"
															alt=""></a>
												</div>
												...
												<div class="Goodup-grid-footer py-2 px-3">
													<div class="Goodup-ft-first">
														<a href="#" class="Goodup-cats-wrap">
															...
															</div><span class="cats-title">Beauty &amp; Makeup</span>
														</a>
													</div>
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/foods/food-02.jpg" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												...
												<div class="Goodup-grid-footer py-2 px-3">
													<div class="Goodup-ft-first">
														<a href="#" class="Goodup-cats-wrap">
															<div class="cats-ico bg-3"><i class="lni lni-cake"></i>
															</div><span class="cats-title">Night Party</span>
														</a>
													</div>
													<div class="Goodup-ft-last">
														<div class="Goodup-inline">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/foods/food-03.jpg" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												...
												<div class="Goodup-grid-footer py-2 px-3">
													<div class="Goodup-ft-first">
														<a href="#" class="Goodup-cats-wrap">
															<div class="cats-ico bg-4"><i
																	class="lni lni-coffee-cup"></i></div><span
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/foods/food-04.jpg" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												<div class="Goodup-caption px-3 py-2">
													...
													<div class="Goodup-location"><i
															class="fas fa-map-marker-alt me-1 theme-cl"></i>Oliy Denver,
														USA</div>
													<div class="Goodup-middle-caption mt-3">
														<p>At vero eos et accusamus et iusto odio dignissimos ducimus
														</p>
													...
													<div class="Goodup-ft-first">
														<a href="#" class="Goodup-cats-wrap">
															<div class="cats-ico bg-5"><i
																	class="lni lni-shopping-basket"></i></div><span
																class="cats-title">Shopping Mall</span>
														</a>
													</div>
													<div class="Goodup-ft-last">
														<div class="Goodup-inline">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/foods/food-05.jpg" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												<div class="Goodup-caption px-3 py-2">
													<div class="Goodup-author"><a href="#"><img src="assets/img/t-5.png"
																class="img-fluid circle" alt=""></a></div>
													<h4 class="mb-0 ft-medium medium"><a href="#"
												...
												<div class="Goodup-grid-footer py-2 px-3">
													<div class="Goodup-ft-first">
														<a href="#" class="Goodup-cats-wrap">
															<div class="cats-ico bg-5"><i
																	class="lni lni-surf-board"></i></div><span
																class="cats-title">Spa &amp; Salon</span>
														</a>
													</div>
													<div class="Goodup-ft-last">
														<div class="Goodup-inline">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/foods/food-06.jpg" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												<div class="Goodup-caption px-3 py-2">
													<div class="Goodup-author"><a href="#"><img src="assets/img/t-6.png"
																class="img-fluid circle" alt=""></a></div>
													<h4 class="mb-0 ft-medium medium"><a href="#"
												...
												<div class="Goodup-grid-footer py-2 px-3">
													<div class="Goodup-ft-first">
														<a href="#" class="Goodup-cats-wrap">
															<div class="cats-ico bg-6"><i class="lni lni-burger"></i>
															</div><span class="cats-title">Food Services</span>
														</a>
													</div>
													<div class="Goodup-ft-last">
														<div class="Goodup-inline">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/foods/food-07.jpg" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												<div class="Goodup-caption px-3 py-2">
													<div class="Goodup-author"><a href="#"><img src="assets/img/t-7.png"
																class="img-fluid circle" alt=""></a></div>
													<h4 class="mb-0 ft-medium medium"><a href="#"
															class="text-dark fs-md">Ubber Shopping Services</a></h4>
													<div class="Goodup-location"><i
															class="fas fa-map-marker-alt me-1 theme-cl"></i>Metrio
														General Store</div>
													<div class="Goodup-middle-caption mt-3">
														<p>At vero eos et accusamus et iusto odio dignissimos ducimus
														</p>
												...
												<div class="Goodup-grid-footer py-2 px-3">
													<div class="Goodup-ft-first">
														<a href="#" class="Goodup-cats-wrap">
															...
															<span class="cats-title">Tour &amp; Travels</span>
														</a>
													</div>
													<div class="Goodup-ft-last">
														<div class="Goodup-inline">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/foods/food-08.jpg" class="img-fluid"
															alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												<div class="Goodup-caption px-3 py-2">
													<div class="Goodup-author"><a href="#"><img src="assets/img/t-8.png"
																class="img-fluid circle" alt=""></a></div>
													<h4 class="mb-0 ft-medium medium"><a href="#"
												...
												<div class="Goodup-grid-footer py-2 px-3">
													<div class="Goodup-ft-first">
														<a href="#" class="Goodup-cats-wrap">
															<div class="cats-ico bg-8"><i class="lni lni-gift"></i>
															</div><span class="cats-title">Wedding</span>
														</a>
													</div>
													<div class="Goodup-ft-last">
														<div class="Goodup-inline">
								...
								<div class="row justify-content-center">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="doctor-grid-view">
											...
											<div class="doctor-grid-caption">
												<div class="doc-title-wrap">
													<h4 class="doc-title verified"><a href="#">Dr. Mary F. Holliday</a>
													</h4>
												</div>
												<span class="doc-designation">MBBS, MS - General Surgery, MCh</span>
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/car/c-1.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/car/c-2.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/car/c-3.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/car/c-4.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/car/c-5.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
											...
											<div class="Goodup-grid-fl-wrap">
												<div class="Goodup-caption px-3 py-2">
													<div class="Goodup-cates multi"><a href="#" class="cats-1">Nexon</a>
													</div>
													<h4 class="mb-0 ft-medium medium"><a href="#"
															class="text-dark fs-md">New Hyundai Creta</a></h4>
													<div class="Goodup-middle-caption mt-2">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/car/c-6.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/car/c-7.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/car/c-8.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/real/r-1.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-prt-price">$<span>30,999</span></div>
												</div>
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/real/r-2.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/real/r-3.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/real/r-4.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/real/r-5.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/real/r-6.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/real/r-7.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/rooms/1.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/rooms/2.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/rooms/3.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/rooms/4.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/rooms/5.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/rooms/6.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/rooms/7.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
									...
									<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
										<div class="Goodup-grid-wrap">
											<div class="Goodup-grid-upper">
												...
												<div class="Goodup-grid-thumb">
													<a href="#" class="d-block text-center m-auto"><img
															src="assets/img/rooms/8.jpg" class="img-fluid" alt=""></a>
												</div>
												<div class="Goodup-rating overlay">
													<div class="Goodup-pr-average high">4.2</div>
													<div class="Goodup-aldeio">
